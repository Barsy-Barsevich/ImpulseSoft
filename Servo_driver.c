...
/*
#define STABA_BIAS              0UI
#define STABB_BIAS              0UI
#define STABC_BIAS              0UI
#define STABD_BIAS              0UI
*/
...
void Servo_Print_Stab() {
    ...
    SERVO_A_OCR = (uint16_t)(StabA * ANGLE_TO_OCR) + STABA_BIAS;
    SERVO_B_OCR = (uint16_t)(StabB * ANGLE_TO_OCR) + STABB_BIAS;
    SERVO_C_OCR = (uint16_t)(StabC * ANGLE_TO_OCR) + STABC_BIAS;
    SERVO_D_OCR = (uint16_t)(StabD * ANGLE_TO_OCR) + STABD_BIAS;
}

void Servo_Print_Zero() {
    // 90 градусов соответствуют значению 24243
    SERVO_A_OCR = SERVO_HALF_PRESCALER + STABA_BIAS;
    SERVO_B_OCR = SERVO_HALF_PRESCALER + STABB_BIAS;
    SERVO_C_OCR = SERVO_HALF_PRESCALER + STABC_BIAS;
    SERVO_D_OCR = SERVO_HALF_PRESCALER + STABD_BIAS;
}
