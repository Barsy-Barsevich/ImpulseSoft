...
bool GET_ACCEL(float *accel) {
    int16_t a_raw[3];
    a_raw[0] = (((uint16_t)raw2_accel[0]<<8)|(uint16_t)raw2_accel[1]);
    a_raw[1] = (((uint16_t)raw2_accel[2]<<8)|(uint16_t)raw2_accel[3]);
    a_raw[2] = (((uint16_t)raw2_accel[4]<<8)|(uint16_t)raw2_accel[5]);
